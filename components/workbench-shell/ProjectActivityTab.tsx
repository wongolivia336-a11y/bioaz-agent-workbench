...
const activityFeed: ActivityEntry[] = [
  { id: "act-1", group: "今天", time: "36 分钟前", actor: "药效报告同事", kind: "产物", title: "生成样本 9 双批次报告 v3", detail: "校验通过 6 项，3 条风险待授权确认", icon: <FileText size={15} /> },
  { id: "act-2", group: "今天", time: "1 小时前", actor: "Admin", kind: "资料", title: "上传 batch9_raw.xlsx", detail: "归入项目资料，已供数字同事读取", icon: <Upload size={15} /> },
  { id: "act-3", group: "今天", time: "2 小时前", actor: "QA 审核同事", kind: "审核", title: "完成数据质控与证据追溯", detail: "终点日缺失值需要研究总监确认", icon: <ShieldCheck size={15} /> },
  { id: "act-4", group: "今天", time: "3 小时前", actor: "李助理", kind: "阻塞", title: "历史对照组数据补充受阻", detail: "上游实验室尚未回传，预计顺延 2 天", icon: <TriangleAlert size={15} /> },
  { id: "act-5", group: "本周", time: "昨天", actor: "DMPK 报价同事", kind: "产物", title: "完成 Balb/c nude 报价单", detail: "计价规则匹配摘要已归档", icon: <Check size={15} /> },
  { id: "act-6", group: "本周", time: "2 天前", actor: "王 SD", kind: "决策", title: "确认 Day28 数据口径", detail: "在任务会话中补充了历史对照说明", icon: <MessageSquare size={15} /> },
  { id: "act-7", group: "本周", time: "3 天前", actor: "张经理", kind: "计划", title: "调整阶段三交付时间", detail: "报告交付由 07-31 顺延至 08-02", icon: <Clock3 size={15} /> },
  { id: "act-8", group: "更早", time: "5 天前", actor: "Admin", kind: "成员", title: "创建项目并邀请数字同事", detail: "药效报告同事、DMPK 报价同事已加入", icon: <Users size={15} /> },
];
