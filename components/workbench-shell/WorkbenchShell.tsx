...
import type { HubTab } from "./FileManager";
...
export default function WorkbenchShell() {
  ...
  /* 项目中枢的 tab 提到 shell 持有：侧栏的收件箱图标要能直接把人送到
     「待我处理」，所以这个状态不能只活在 FileManager 里面。 */
  const [hubTab, setHubTab] = useState<HubTab>("data");
