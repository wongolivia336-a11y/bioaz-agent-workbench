...
export default function WorkbenchShell() {
  ...
  const startTaskFromMail = ({ subject, project: contextProject, context, moduleId }: { subject: string; project?: string; context: string; moduleId?: "qa-review" | "dmpk-quotation" }) => {
