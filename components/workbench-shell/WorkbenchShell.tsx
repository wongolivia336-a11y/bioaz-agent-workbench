...
export default function WorkbenchShell() {
  ...
  const backOffice = quotationTarget
    ? <QuotationManagement onBack={() => setQuotationTarget(null)} initialBusiness={quotationTarget.business} initialTab={quotationTarget.tab} initialDraft={quotationTarget.draft} />
    : null;
