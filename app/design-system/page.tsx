...
const components = [
  ...
  { name: "WorkbenchPanel", status: "candidate", props: "panels, visibleIds, onVisibleIdsChange, activePanelId, onPanelChange, hintIds", use: "Agent 会话右侧常驻工作面板：tab 栏 + 加号选择显示哪些面板", avoid: "不要再和别的右侧浮层互斥；tab 清单固定，不做可重复实例" },
